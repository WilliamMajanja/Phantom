        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400 max-w-2xl mt-3">
              A Max for Live companion workflow that turns PHANTOM scenes into Live Session clips, routes Web MIDI through the PHANTOM
              Live Bridge port, and exposes performance macros for racks, resampling, and Ghost Bridge AI clip generation.
            </p>
          </div>
